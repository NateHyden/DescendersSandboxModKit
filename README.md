<p align="center">
  <img src="docs/banner.png" alt="Descenders Sandbox" width="700">
</p>

# Descenders Sandbox

[![Latest Release](https://img.shields.io/github/v/release/NateHyden/DescendersSandboxModKit?label=latest)](https://github.com/NateHyden/DescendersSandboxModKit/releases)
[![Downloads](https://img.shields.io/github/downloads/NateHyden/DescendersSandboxModKit/total)](https://github.com/NateHyden/DescendersSandboxModKit/releases)
[![Discord](https://img.shields.io/badge/Discord-Join-5865F2?logo=discord&logoColor=white)](https://discord.gg/rHvCrBdqaR)
[![MelonLoader](https://img.shields.io/badge/MelonLoader-Download-blue)](https://github.com/LavaGang/MelonLoader/releases)
...
100+ tools across 24 categories. Jump to what you're after:

[Object Placing](#object-placing) · [Bike Physics](#bike-physics) · [Bike Setup](#bike-setup) · [Movement & Controls](#movement-controls) · [World](#world) · [Map](#map) · [Fun](#fun) · [Chaos & Extras](#chaos-extras) · [Outfit](#outfit) · [Chat](#chat) · [Modes](#modes) · [Ghost Replay](#ghost-replay) · [Teleport](#teleport) · [Screenshot](#screenshot) · [Session](#session) · [Graphics](#graphics) · [Favourites](#favourites) · [Key Binds](#key-binds) · [Customise](#customise) · [Career Progression](#career-progression) · [System](#system)
...
**Lux Glow** — full outfit tinting, independent of the game's own Lux system:
...
<details>
<summary><strong>Step-by-step Xbox install</strong></summary>
...
<details>
<summary><strong>Telemetry details</strong></summary>
...
<details>
<summary><strong>Why does the mod use PowerShell?</strong></summary>
...
- **VirusTotal:** [scan results](https://www.virustotal.com/gui/file/67b7803333971bdbf57e04c3793d0a009480cfeef0b72de166c96c488cb8dc35/detection)
